...
final class DefaultControllerTest extends WebTestCase
{
    ...
    /**
     * Ensures locale selection via query string does not trigger a redirect loop.
     */
    // Generated by GitHub Copilot
    public function testHomepageLocaleQueryLoadsSuccessfully(): void
    {
        $client = static::createClient();
        $client->request('GET', '/?_locale=pt_BR');
